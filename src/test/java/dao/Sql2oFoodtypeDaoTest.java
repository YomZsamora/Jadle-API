...
public class Sql2oFoodtypeDaoTest {
    ...
    @Test
    public void findByIdGetsCorrectFoodType() throws Exception {
        Foodtype testFoodtype = setupNewFoodtype();
        foodtypeDao.add(testFoodtype);
        Foodtype foundFoodtype = foodtypeDao.findById(testFoodtype.getId());
        assertEquals(testFoodtype.getName(), foundFoodtype.getName());
    }
